        ...
        <div class="news-social-links">
          <p>
            ...
            <?php if (!empty(carbon_get_theme_option( 'qavs_facebook' ))): ?>
              <a href="<?php echo carbon_get_theme_option( 'qavs_twitter' );?>" class="news__social-link" aria-label="Twitter">
            ...
            <?php if (!empty(carbon_get_theme_option( 'qavs_facebook' ))): ?>
              <a href="<?php echo carbon_get_theme_option( 'qavs_facebook' );?>" class="news__social-link" aria-label="Facebook">
