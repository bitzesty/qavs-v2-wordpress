...
<head>
  <?php if(qavs_analytics_cookies_consent()): ?>
    ...
    <script>
      ...
      gtag('config', 'G-M130LYYCBV', { 'anonymize_ip': true, cookieDomain: 'auto' });
    </script>
  <?php endif; ?>
    ...
    <section class="pre-header" title="Top bar links">
      <div class="container">
        ...
        <?php if (!empty(carbon_get_theme_option( 'qavs_twitter' ))): ?>
          <a href="<?php echo carbon_get_theme_option( 'qavs_twitter' );?>" class="pre-header__social-link twitter" aria-label="Twitter profile" title="Click to read" target="_blank" rel="noopener nofollow">
        ...
        <?php if (!empty(carbon_get_theme_option( 'qavs_facebook' ))): ?>
          <a href="<?php echo carbon_get_theme_option( 'qavs_facebook' );?>" class="pre-header__social-link facebook" aria-label="Facebook profile" title="Click to read" target="_blank" rel="noopener nofollow">
