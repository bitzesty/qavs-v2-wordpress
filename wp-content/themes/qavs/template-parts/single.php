      ...
      <div class="article__body">
        ...
        <div class="article__sharing">
          ...
          <nav aria-labelledby="share-article-title" class="sharing-buttons">
            <a rel="noopener nofollow" target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&title=<?php echo qavs_sharing_title(); ?>&source=<?php echo urlencode(qavs_website_name()); ?>&url=<?php echo qavs_sharing_url(); ?>&summary=<?php echo qavs_sharing_text(); ?>"  aria-label="Share this news article on LinkedIn">
            ...
            <a rel="noopener nofollow" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo qavs_sharing_url(); ?>&title=<?php echo qavs_sharing_title(); ?>&description=<?php echo qavs_sharing_text(); ?>" aria-label="Share this news article on Facebook">
